...
function changeTabPanel(e) {
    ...
    const targetImage = targetTab.getAttribute("")
    ...
    mainContainer.querySelector([`#${targetImage}`]).removeAttribute('hidden'); // remove hidden attribute on selected targetPanel
}